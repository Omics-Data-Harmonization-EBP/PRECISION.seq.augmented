...
A precision object with RUVr harmonization results added to the slots
`harmon.train.data`, `harmon.test1.data`, and `harmon.test2.data` (if
applicable).

## Details

This function applies RUVr (using residuals) harmonization to the raw
data contained in a precision object. The harmonization results are
