...
DESeq normalization for miRNA-Seq data using the DESeq2 package. For
more information, visit the documentation on the [DESeq2 package
...
A precision object with DESeq harmonization results added to the slots
