...
PoissonSeq normalization for miRNA-Seq data using the PoissonSeq
package. For more information, visit the [PoissonSeq GitHub
repository](https://github.com/cran/PoissonSeq).

## Usage

``` r
harmon.PoissonSeq(object)
```
...
A precision object with PoissonSeq harmonization results added to the
slots `harmon.train.data`, `harmon.test1.data`, and `harmon.test2.data`
(if applicable).

## Details

This function applies PoissonSeq harmonization to the raw data contained
