...
SVA normalization for miRNA-Seq data using the sva package. For more
information, visit the documentation on the [sva package
website](https://bioconductor.org/packages/release/bioc/html/sva.html).
...
A precision object with SVA harmonization results added to the slots
...
precision object. The harmonization results are added to the
